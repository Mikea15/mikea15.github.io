...
TL;DR; [Marko Vale](https://twitter.com/MarcoValeKaz) and I made a game for Ludum Dare 38 in 72h that [you can play here](https://mikea15.itch.io/astromike). What follows is a small post mortem.
...
![Intro Level](/img/Pasted-image-at-2017_04_22-01_33-PM.png) 
...
At this point, I had a friend of mine, [Marco Vale](https://twitter.com/MarcoValeKaz), asking if I needed an artist, so we teamed-up and he started to create assets for the game's environment, as well as a character, gun, jetpack and a crashed ship, while I was developing game mechanics. Soon after that, I had a node-based navigation working, and something a lot prettier than cubes to show.
...
https://twitter.com/MichaelAdaixo/status/856193366006038530
...
https://twitter.com/MichaelAdaixo/status/856553416260280321

I started the Ludum Dare alone, with a faint idea of what to do, and with [Marko](https://twitter.com/MarcoValeKaz)'s amazing help, we were able to make something really nice, and learn a lot in the process. I think this is the most fun I've had making games in quite a while, and definitely my best LD entry so far. 72h later, I'm proud of the game we've created. [Feel free to try it out](https://mikea15.itch.io/astromike), and leave a comment if you like.
